    ...
    FFLogsLocation FFLogs)
{
    ...
    [
        ...
        new("m9s", Category.SAVAGE, new(1321),
            new(TomestoneLocation.TomestoneCategory.SAVAGE, "vamp-fatale", ExpansionQueryParam.DT,  new(5409)),
            new(new FFLogsLocation.FFLogsZone(101, false))),
        new("m10s", Category.SAVAGE, new(1323),
            new(TomestoneLocation.TomestoneCategory.SAVAGE, "red-hot-deep-blue", ExpansionQueryParam.DT,  new(5410)),
            new(new FFLogsLocation.FFLogsZone(102, false))),
        new("m11s", Category.SAVAGE, new(1325),
            new(TomestoneLocation.TomestoneCategory.SAVAGE, "the-tyrant", ExpansionQueryParam.DT, new(5411)),
            new(new FFLogsLocation.FFLogsZone(103, false))),
        new("m12sp1", Category.SAVAGE, new(1327),
            new(TomestoneLocation.TomestoneCategory.SAVAGE, "lindwurm", ExpansionQueryParam.DT, new(5412)),
            new(new FFLogsLocation.FFLogsZone(104, false))),
        new("m12sp2", Category.SAVAGE, null,
            new(TomestoneLocation.TomestoneCategory.SAVAGE, "lindwurm-ii", ExpansionQueryParam.DT, new(5413)),
