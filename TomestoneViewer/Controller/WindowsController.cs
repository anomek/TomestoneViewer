...
public class WindowsController(CharacterSelectorController characterSelectorController)
{
    ...
    public void RegisterWindows(MainWindow mainWindow, ConfigWindow configWindow)
    {
